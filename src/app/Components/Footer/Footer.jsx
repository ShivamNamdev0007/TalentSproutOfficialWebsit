...
export default function Footer() {
  ...
  const services = [
    { name: "IT & GCC Recruitment", link: "/services/ItGcc" },
    { name: "BFSI & Banking Recruitment", link: "/services/BFSIPage" },
    { name: "Staffing Solutions", link: "/services/Staffing" },
    { name: "POSH Training & Compliance", link: "/services/POSHTraning" },
    { name: "Empathy & Personality Development", link: "/services/Empathy " },
  ];
  ...
  return (
    <footer className="w-full bg-[#2C2F34] text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-0 z-0">
        <svg viewBox="0 0 1440 180" preserveAspectRatio="none" className="w-full h-32">
          <path
            ...
            <ul className="space-y-3">
              {services.map((item, index) => (
                <Link key={index} href={item.link}>
                  <li className="group flex items-center gap-2 cursor-pointer overflow-hidden">
...
hover:after:w-full`}>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="group flex items-start gap-2 cursor-pointer overflow-hidden">
                <FiMapPin size={18} className="text-[#F05A28] mt-1" />
                <span className="text-[#F05A28] text-sm transform -translate-x-3 opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
                  &gt;
                </span>
                <p className="text-gray-400 text-sm transition-all duration-300 group-hover:text-[#F05A28] group-hover:translate-x-1">
                  6193 ATS Dolce Zeta 1, Greater Noida 201306
                </p>
              </div>

              <div className="group flex items-start gap-2 cursor-pointer overflow-hidden">
                <FiMail size={18} className="text-[#F05A28]" />
                <span className="text-[#F05A28] text-sm transform -translate-x-3 opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
                  &gt;
                </span>
                <p className="text-gray-400 text-sm transition-all duration-300 group-hover:text-[#F05A28] group-hover:translate-x-1">
              ...
              <div className="group flex items-start gap-2 cursor-pointer overflow-hidden">
                <FiPhone size={18} className="text-[#F05A28]" />
                <span className="text-[#F05A28] text-sm transform -translate-x-3 opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
                  &gt;
                </span>
                <p className="text-gray-400 text-sm transition-all duration-300 group-hover:text-[#F05A28] group-hover:translate-x-1">
