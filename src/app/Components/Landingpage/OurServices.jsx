  ...
  return (
    <section className="py-16 px-4">
      <div className="text-center max-w-3xl mx-auto mb-12">
        <h2 className="text-4xl md:text-5xl font-bold text-black mb-4">
          Our{" "}
          <span className="text-4xl md:text-5xl font-bold text-orange-500 mb-4">
            Services
          </span>
        </h2>
        <p className="text-gray-400 text-base md:text-lg">
          ...
          {services.map((service, index) => (
            <SwiperSlide key={index}>
              <div
                ...
                className="group relative h-105 rounded-2xl overflow-hidden border border-gray-700 hover:border-orange-500 transition-all duration-300 cursor-pointer md:cursor-default"
              >
                <Image
                  src={service.image}
                  alt={service.title}
