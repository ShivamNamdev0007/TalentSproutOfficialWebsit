  ...
  return (
    <section className="relative w-full min-h-[85vh] flex items-center justify-center text-center text-white overflow-hidden rounded-b-3xl">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/PoshHeros.jpg')", // replace with your image
        }}
      />
      ...
      <div className="relative z-10 max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
          POSH Training That Builds Safe &
          <span className="text-orange-500"> Respectful Workplaces</span>
        </h1>

        {/* Paragraph */}
        <p className="mt-6 text-base sm:text-lg md:text-xl text-gray-200 leading-relaxed">
         We deliver POSH (Prevention of Sexual Harassment) training aligned with statutory guidelines for corporates, startups, and colleges.
         </p>
