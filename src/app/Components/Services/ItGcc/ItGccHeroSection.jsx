...
export default function ItGccHeroSection() {
  return (
    <section className="relative w-full min-h-[85vh] flex items-center justify-center text-center text-white overflow-hidden rounded-b-3xl">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/ItGcHeros.jpg')", // replace with your image
        }}
      />
      ...
      <div className="relative z-10 max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-6 text-base sm:text-lg md:text-xl text-gray-200 leading-relaxed">
          We specialize in IT recruitment for Global Capability Centers (GCCs),
          startups, and enterprises, delivering skilled tech professionals aligned
          with both technical and cultural needs.
        </p>

        {/* Buttons */}
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          
          {/* Primary Button */}<Link href="/contact">
